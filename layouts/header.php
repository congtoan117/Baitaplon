    ...
    <div id="header">
                        ...
                        <nav id="header-nav-top">
                            <ul class="list-inline pull-right" id="headermenu">
                                ...
                                <?php if (isset($_SESSION['name_user'])): ?>
                                    <li>
                                        Xin chào: <strong style="color: white;"><?php echo $_SESSION['name_user'] ?></strong>
                                    </li>
                                    <li>
        ...
        <div class="container">
            <div class="row" id="header-main">
                ...
                <div class="col-md-4">
                    <a href="">
                        <img class="logo-img" src="<?php echo uploads() ?>/logo/t&t.png">
                    </a>
                </div>
    ...
    <div id="maincontent">
        <div class="container">
            <div class="col-md-3  fixside" >
                ...
                <div class="box-left box-menu">
                    <h3 class="box-title"><i class="fa fa-mobile"></i>  Sản phẩm mới </h3>
