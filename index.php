        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item item-img active">
                    <img src="<?php echo uploads() ?>/slider/phone0.webp" alt="Los Angeles" style="width:100%;">
                </div>

                <div class="item item-img">
                    <img src="<?php echo uploads() ?>/slider/phone1.webp" alt="Chicago" style="width:100%;">
                </div>

                <div class="item item-img">
                    <img src="<?php echo uploads() ?>/slider/phone2.webp" alt="New York" style="width:100%;">
                </div>

                <div class="item item-img">
                    <img src="<?php echo uploads() ?>/slider/phone3.webp" alt="New York" style="width:100%;">
                </div>
    ...
    <section class="box-main1">
                ...
                <div class="col-md-3 col-xs-12 item-product">
                    <div class="item-product-custom border bor">
                        <a href="product-detail.php?id=<?php echo $item['id'] ?>">
                            <img src="<?php echo uploads() ?>/product/<?php echo $item['thumbar'] ?>" class=""
                        ...
                        <div class="info-item">
                            ...
                            <?php else: ?>
                            <p><b style="color: #ea3a3c;">
                                    <?php echo formatPrice($item['price']) ?>
                                </b></p>
                            <?php endif; ?>
                        </div>
                        <div class="hidenitem">
                            <p><a href="product-detail.php?id=<?php echo $item['id'] ?>"><i
        ...
        <div class="banner-motor">
            <div class="bannerBlock imageHover">
                <a href="">
                    <img src="<?php echo base_url() ?>public/frontend/images/iphone15.webp" alt="Kawasaki">
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="post-custom">
                            <div class="post-img">
                                <a href="post-detail.php?id=<?php echo $item['id'] ?>"
