...
<?php require_once __DIR__."/../../layouts/header.php"; ?>
    ...
    <div class="container" id="printableArea" >
                        ...
                        <ul>
                            <li>
                                <ul class="item-order">
                                    ...
                                    <li class="order-item-2">mobile shop T&T</li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul class="item-order">
                                    ...
                                    <li class="order-item-2">congtoan@gmail.com</li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul class="item-order">
                                    ...
                                    <li class="order-item-2">0559898874</li>
                                </ul>
                            </li>
                            <li>
                                <ul class="item-order">
        ...
        <div class="order-5">
            <p>
                * Trung tâm bảo hành mobile shop T&T - điện thoại chính hãng: Tại Hà Nội: ĐC: Cửa hàng điện thoại - mobile shop T&T. Địa chỉ: Hà Nội.
            ...
            <ul class="note-list">
                ...
                <li>
                    2. Quý khách vui lòng mang máy đến trung tâm bảo hành của cửa hàng mobile shop T&T để bảo hành theo thời hạn.
                </li>
            </ul>
            <p>
                <i>
